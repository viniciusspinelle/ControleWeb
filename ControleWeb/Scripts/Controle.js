var controle = {
    ...
    //            if (xhr.status === 401) {
    //                dontus.showErrorAlert('<strong>Usuário não tem permissão para executar essa ação, por favor entrar em contato com administrador do sistema! </strong><br />');
    //            }
    //            else {
    //                console.log(xhr.responseText);
    //                console.log(xhr);
    //                dontus.showErrorAlert(xhr.responseText);
    //            }
    ...
    formataData: function (value, mask) {
        ...
        var defaultMask = 'YYYY-MM-DDTHH:mm:ss.SSSZZ';
